...
namespace Jane.Mob.Push
{
    public class MobPushMessage
    {
        ...
        /// 3、横幅则为多行内容
        /// </summary>
        [JsonProperty("androidContent")]
        public List<string> AndroidContent { get; set; }

        /// <summary>
        /// 指示灯，默认true
        /// </summary>
        [JsonProperty("androidLight")]
        public bool? AndroidLight { get; set; }

        /// <summary>
        /// 震动，默认true
        /// </summary>
        [JsonProperty("androidShake")]
        ...
        /// hangup(3,”横幅（收件箱）通知”);
        /// </summary>
        [JsonProperty("androidstyle")]
        public int? AndroidStyle { get; set; }

        /// <summary>
        /// Android显示标题
        /// </summary>
        [JsonProperty("androidTitle")]
        ...
        /// </summary>
        [JsonProperty("iosBadge")]
        public int? IOSBadge { get; set; }

        /// <summary>
        /// 只有IOS8及以上系统才支持此参数推送
        /// </summary>
        [JsonProperty("iosCategory")]
        public string IOSCategory { get; set; }

        [JsonProperty("iosContentAvailable")]
