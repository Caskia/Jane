...
namespace Jane.Dependency
{
    ...
    public interface IObjectContainer
    {
        ...
        void Register<TService, TImplementer>(string serviceName = null, DependencyLifeStyle life = DependencyLifeStyle.Singleton)
        ...
        /// <param name="serviceName">The service name.</param>
        /// <param name="life">The life cycle of the implementer type.</param>
        void RegisterType(Type implementationType, string serviceName = null, DependencyLifeStyle life = DependencyLifeStyle.Singleton);
