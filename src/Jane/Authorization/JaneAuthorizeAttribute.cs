...
namespace Jane.Authorization
{
    ...
    public class JaneAuthorizeAttribute : Attribute, IJaneAuthorizeAttribute
    {
        /// <summary>
        /// Creates a new instance of <see cref="JaneAuthorizeAttribute"/> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public JaneAuthorizeAttribute(params string[] permissions)
        {
